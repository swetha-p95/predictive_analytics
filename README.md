This repository contains the solutions to the following problems (Polynomial Regression and Logistic Regression) given as exercise in the Predictive Analytics class (2024):
